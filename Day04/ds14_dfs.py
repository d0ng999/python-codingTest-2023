...
if __name__ == '__main__':
    ...
    print('방문순서 -->', end  = ' ')
    for i in visitedAry:
        if i == visitedAry[len(visitedAry)-1]:
            print(chr(ord('A')+i))
        else:
